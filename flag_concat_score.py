...
flag_header = ["vid", "title", "date", "description", "viewCount", "likeCount", "dislikeCount", "commentCount", "videoTime", "DeadEndCount", "shibouflagCount", "seizonflagCount", "renaiflagCount", "rank", "score"]
...
#print(rank)
concat_csv = pd.concat([datasets, rank, score], axis=1)
