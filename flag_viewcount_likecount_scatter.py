...
# グラフプロット
## 再生回数と動画時間の散布図をプロット
sc = plt.scatter(y2, y1, s=50, c="r", alpha=0.5, linewidths=1, edgecolors="k")
#plt.colorbar()


coef = P.polyfit(y2, y1, 1)
 
# 作成した多項式近似を表示
print("viewCount & likeCount approximate: " + 'y = ' + str(coef[0]) + ' + ' + str(coef[1]) + ' * x')
...
# ラベル名
plt.xlabel("高評価数", fontsize=10, fontname="TakaoPGothic")
...
#画像保存
plt.savefig("flag_viewCount_likeCount_scatter_graph.png", bbox_inches="tight", pad_inches=0.0)